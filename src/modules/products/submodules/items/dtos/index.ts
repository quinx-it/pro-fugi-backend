...
export * from '@/modules/products/submodules/items/dtos/update-product-item.dto';
export * from '@/modules/products/submodules/items/dtos/product-image.dto';
export * from '@/modules/products/submodules/items/dtos/product-items-paginated.dto';
